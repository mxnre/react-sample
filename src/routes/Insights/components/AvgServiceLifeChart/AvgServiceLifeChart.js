...
import data from 'data/money-spent.json'
...
const getChartData = data => {
  return {
    ...
    datasets: [
      {
        label: "Average Service Life in Years ( C )' by 'County'",
        borderColor: colors,
...
const AvgServiceLifeChart = () => {
  ...
  return (
    <div className="AvgServiceLifeChart flex-grow-1 d-flex position-relative" ref={wrapperEl}>
      <BarChart data={getChartData(data)} options={options} redraw {...size} />
    </div>
  )
}

export default AvgServiceLifeChart
